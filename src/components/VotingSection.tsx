...
const FORMSPREE_ACTION_URL = "https://formspree.io/f/manjkynp";

const formFieldMap = {
  "Chairperson": { name: "entry.1111111111", year: "entry.1111111112" },
  "1st Vice Chairperson": { name: "entry.2222222221", year: "entry.2222222222" },
  "2nd Vice Chairperson": { name: "entry.3333333331", year: "entry.3333333332" },
  "Secretary": { name: "entry.4444444441", year: "entry.4444444442" },
  "Vice Secretary": { name: "entry.5555555551", year: "entry.5555555552" },
  "Treasurer": { name: "entry.6666666661", year: "entry.6666666662" },
  "In Reach Coordinator": { name: "entry.7777777771", year: "entry.7777777772" },
  "Out Reach Coordinator": { name: "entry.8888888881", year: "entry.8888888882" },
  "Bible Study and Training Coordinator": { name: "entry.9999999991", year: "entry.9999999992" },
  "Worship Coordinator": { name: "entry.1010101011", year: "entry.1010101012" },
  "Resource Mobilization and Management Coordinator": { name: "entry.1111111121", year: "entry.1111111122" },
  "Prayer Coordinator": { name: "entry.1212121211", year: "entry.1212121212" },
  "Creative Ministry Coordinator": { name: "entry.1313131311", year: "entry.1313131312" },
};
...
const VotingSection = () => {
  ...
  const positions = Object.keys(formFieldMap);

  const handleVoteSubmit = async (position: string, candidateName: string, yearOfStudy: string) => {
    ...
    formData.append("yearOfStudy", yearOfStudy.trim());
