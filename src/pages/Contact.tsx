...
const Contact = () => {
  const contactInfo = [
    {
      ...
      details: [
        ...
        "Upper Kabete Campus",
        "Faculty of Agriculture, 844 hall",
    ...
    },
    {
      ...
      title: "Office Hours",
      details: [
        "Monday - Friday - Sunday: 5PM - 6PM",
        "Saturday: 9:00 AM - 6:00 PM",
        "Sunday: After Service - 2:00 PM",
        "Closed during school break holidays"
      ]
    }
  ];
  ...
  const officeLocation = {
    ...
    directions: "Located in the School area, Faculty of Macroeconomics, 844 hall. Enter through the main's hall door and take the stairs to the hall down below, at the podium on the left, you will see the door of our office.",
    mapUrl: "https://g.co/kgs/RfC6xeg"
  };
            ...
            <div>
              ...
              <Card className="p-6">
                <CardContent className="space-y-6">
                  <form action="https://formspree.io/f/xanjvaza" method="POST">
                    ...
                    <div>
                      ...
                      <select id="category" name="category" className="w-full p-2 border border-gray-300 rounded-md">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Sunday services are at 10:00 AM, and our weekly Bible study is every Wednesday from 5:00PM - 6:30PM.
              </p>
