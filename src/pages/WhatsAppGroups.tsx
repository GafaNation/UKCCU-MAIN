...
import { MessageCircle, Users, Calendar, BookOpen, Heart, Cross, Music, HandHeart, Globe, Camera, Star, Hand, Gift, Videotape, Home } from "lucide-react";
...
const WhatsAppGroups = () => {
  const ministryGroups = [
    {
      title: "UKCCU UPDATES GROUP",
      description: "The main group for all important Christian Union updates and announcements",
      members: "468 members",
      icon: Home,
    ...
    },
    {
      ...
      description: "A group focused on digging deep into God's word and growing in understanding",
      members: "89 members",
      icon: BookOpen,
    ...
    {
      title: "INTERCESSORY GROUP",
      description: "Committed to prayer and spiritual covering for the union and it's members",
      members: "148 members",
      icon: Heart,
    ...
    },
    {
      ...
      description: "Leading the union in heartfelt worship and praise through music",
      members: "204 members",
      icon: Users,
    ...
    {
      title: "MEDIA TEAM",
      description: "Capturing moments, creating content, and managing the union's digital presence.",
      members: "56 members",
      icon: Camera,
    ...
    {
      title: "RUBIES GROUP(Ladies)",
      description: "Sisterhood, where ladies gather to encourage, empower, and grow in faith",
      members: "153 members",
      icon: Heart,
    ...
    {
      title: "LIVINGSTONE GROUP(Men)",
      description: "A space for all men in the union to grow spiritually and support one another",
      members: "104 members",
      icon: Users,
    ...
    {
      title: "SOUND TEAM",
      description: "Handles sound setup, microphones, and all things audio during services and events",
      members: "54 members",
      icon: Music,
    ...
    },
    {
      ...
      description: "Incharge of ushering, decor, and bringing beauty and order to our gatherings.",
      members: "84 members",
      icon: Globe,
    ...
    },
    {
      ...
      description: "Ensuring everyone is cared for and fed well and also focused on kitchen services and refreshments",
      members: "62 members",
      icon: HandHeart,
    ...
    {
      title: "GALAXIES",
      description: "Our vibrant dance team that ministers through creative movement and worship.",
      members: "28 members",
      icon: Videotape,
      whatsappLink: "https://chat.whatsapp.com/media-technology",
      isActive: true
    },
    {
      ...
      description: "A group dedicated to reaching out and serving in children's homes and other compassionate missions",
      members: "58 members",
      icon: Gift,
      whatsappLink: "https://chat.whatsapp.com/media-technology",
      isActive: true
  ...
  const eventGroups = [
    {
      title: "Weekly Instruments Training",
      description: "A group for those who want to learn playing instruments like Guitar, Keyboard, and drums. You will have a chance to also imrove your skills",
      members: "156 members",
      icon: Music,
    ...
    },
    {
      ...
      description: "Community build-up, we teach and spend time with the children around school and from the community",
      members: "234 members",
      icon: Cross,
    ...
    },
    {
      ...
      description: "We visit schools around the community and those in Kenya preaching the gospel to them.",
      members: "187 members",
      icon: Calendar,
