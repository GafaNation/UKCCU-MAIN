...
const Index = () => {
  const upcomingEvents = [
    ...
    },
    {
      ...
      time: "5:00PM - 6:30PM",
      location: "GUIDED BY THE BIBLE STUDY PASTOR",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl lg:text-6xl font-bold mb-6 animate-fade-in">
              WHERE IT HAPPENS THE KINGDOM'S WAY
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" variant="outline" className="bg-white text-blue-600 hover:bg-gray-100 font-semibold px-8">
            ...
            <Card className="bg-white/10 border-white/20 text-white backdrop-blur">
              ...
              <CardContent>
                <ul className="space-y-2 text-white/90 mb-4">
                  <li>• Sunday Services - 9:OOAM - 12NOON EAT</li>
                  <li>• Friday Services - 7:00PM - 9:30PMEAT</li>
