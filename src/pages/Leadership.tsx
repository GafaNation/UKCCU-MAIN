  ...
  const executiveTeam = [
    {
      ...
      image: "photos and videos/GIBSON.jpeg",
      bio: "Gibson is a student pursuing Bachelor of Agriculture, Drylands resource management (Major). He has been with UKCCU from 1st Year and has a heart for leadership development and mentorship.",
      email: "gibson@student.uonbi.ac.ke",
    ...
    },
    {
      ...
      image: "photos and videos/LONNA.jpeg",
      bio: "Lonna is pursuing a degree in Veterinary Medicine and has been actively involved in women's ministry and counseling within the fellowship.",
      email: "lonna@student.uonbi.ac.ke",
    ...
    },
    {
      ...
      image: "photos and videos/KIBET.jpeg", 
      bio: "Kevin is born again.",
      email: "kevin@student.uonbi.ac.ke",
    ...
    },
    {
      name: "RUTH MWIKALI",
      position: "Secretary",
      image: "photos and videos/RUTHIE.jpeg",
      bio: "Ruth is born again in Christ",
      email: "ruth@student.uonbi.ac.ke", 
    ...
    },
    {
      ...
      image: "photos and videos/VICTOR.jpeg",
      bio: "Victor is born again.",
      email: "victor@student.uonbi.ac.ke",
      phone: "+254 712 345 678",
      department: "Veterinary Medicine"
    },
    {
      name: "JANE WANGUI",
      position: "Treasure",
      image: "photos and videos/JANE.jpeg",
      bio: "Jane is born again.",
      email: "jane@student.uonbi.ac.ke",
      phone: "+254 712 345 678",
      department: "Agriculture"
    },
    {
      name: "ELIUS PORIOT",
      position: "In Reach Coordinator",
      image: "photos and videos/ELIAS.jpeg",
      bio: "Elius is born again in Christ",
      email: "elius@student.uonbi.ac.ke",
      phone: "+254 712 345 678",
      department: "Agriculture"
    },
    {
      ...
      image: "photos and videos/CINDY.jpg",
    ...
    {
      name: "FAITH KALAMA",
      position: "Bible Study and Training Coordinator",
      image: "photos and videos/FAITH KALAMA.jpeg",
      bio: "Faith is born again in Christ",
      email: "faith@student.uonbi.ac.ke",
      phone: "+254 712 345 678",
      department: "Food Science and Technology"
    },
    {
      name: "CLAUDIA NYAMBURA",
      position: "Worship Coordinator",
      image: "photos and videos/CLAUDIA.jpeg",
      bio: "Claudia is born again.",
      email: "claudia@student.uonbi.ac.ke",
      phone: "+254 712 345 678",
      department: "Macroeconomics"
    },
    {
      name: "MARK DAVIES",
      position: "Resourse Mobilization and Management Coordinator",
      image: "photos and videos/MARK.jpeg",
      bio: "Mark Davies is born again",
      email: "mark@student.uonbi.ac.ke",
      phone: "+254 712 345 678",
      department: "Veterinary Medicine"
    },
    {
      ...
      image: "photos and videos/CATE.jpeg",
      bio: "Cate is born again",
      email: "cate@student.uonbi.ac.ke",
      phone: "+254 712 345 678",
      department: "Agriculture"
    },
    {
      name: "PAUL MWAKIRUNGU",
      position: "Creative Ministry Coordinator",
      image: "photos and videos/MWAKI.jpeg",
      bio: "Mwaki is born again.",
      email: "mwaki@student.uonbi.ac.ke",
      phone: "+254 712 345 678",
      department: "Macroeconomics"
    },
  ];
              ...
              <Card key={index} className="hover:shadow-lg transition-shadow">
                <CardHeader className="text-center">
                  <img 
                    src={leader.image} 
                    alt={leader.name}
                    className="w-25 h-29 rounded-full mx-auto mb-4 object-cover"
                  />
