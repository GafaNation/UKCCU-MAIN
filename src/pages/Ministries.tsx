...
const Ministries = () => {
  ...
  const ministries = [
    ...
    },
    {
      ...
      icon: BookOpen,
      leader: "Bible Study Pastor",
      members: 15,
      meetingTime: "WEDNESDAY 5:00pm-6:40pm",
      location: "Guided by Study Pastor",
      activities: [
    ...
    },
    {
      ...
      leader: "Felix Mwashi",
      members: 34,
      meetingTime: "Saturday 8:00AM",
      location: "Sunday School Ground",
      activities: [
        "Sunday School Classes",
        "Children's Sermon Service",
        "Games and Playing",
        "Children's Choir",
        "Family Fun Events"
      ],
    ...
    },
    {
      ...
      fullDescription: "Our nology Ministry ensures that our services run smoothly through professional audio, video, and lighting support. We also manage our online presence, live streaming, and social media platforms to extend our reach beyond the physical church building.",
      icon: Headphones,
      leader: "Victor Makanga",
      members: 28,
      meetingTime: "Saturday 10:00AM",
      location: "Media Room",
      activities: [
    ...
    },
    {
      ...
      leader: "Lonna",
      members: 41,
      meetingTime: "Sunday 6:30AM & Friday 6:00PM",
      location: "UKCCU's Kitchen",
      activities: [
        "Sunday after service tea",
        "Guests special meals",
    ...
    },
    {
      ...
      leader: "Cate Watuthu",
      members: 67,
      meetingTime: "Daily 5:00 AM, 1:00PM, Friday 6:00PM, & Sunday 8:00PMs",
      location: "Gethsemane & 844",
      activities: [
      ...
      <section className="py-16 bg-purple-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="bg-white text-purple-600 hover:bg-gray-100 font-semibold" asChild>
              <Link to="/whatsapp-groups">
